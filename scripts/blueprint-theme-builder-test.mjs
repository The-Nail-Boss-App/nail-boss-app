...
assert(galleryRendererSource.includes('getBlueprintGalleryAutoScaleStyle') && galleryRendererSource.includes("--gallery-art-fill") && galleryRendererSource.includes("88%"), 'BlueprintGalleryRenderer auto scales artwork to fill the tray');

...
assert(shopSource.includes("width: 'min(100%, clamp(92px, 20vw, 124px))'"), 'library card preview uses enlarged clamp-based nail sizing');
assert(shopSource.includes("maxHeight: 164"), 'library card preview increases nail height allowance');
assert(shopSource.includes("padding: 'clamp(2px, .7vw, 5px)'"), 'library card tray padding is reduced');
assert(shopSource.includes("gap: 'clamp(1px, .35vw, 3px)'"), 'library card preview row gap is reduced');
assert(shopSource.includes("gap: 'clamp(1px, .25vw, 3px)'"), 'library card preview nail column gap is reduced');
assert(shopSource.includes("aspectRatio: '1.18 / 1'") && shopSource.includes('minHeight: 260'), 'library card preview window target is increased');

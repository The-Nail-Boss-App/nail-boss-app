...
assert(designStudioSource.includes('function addGradient()') && designStudioSource.includes('aria-label="Add gradient layer"') && !designStudioSource.includes('Add Ombré / Gradient'), 'Gradient/ombré entry point exists once and is not duplicated');

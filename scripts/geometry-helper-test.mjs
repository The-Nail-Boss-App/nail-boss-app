...
assert(nailCanvasSource.includes('data-zoom-transform-origin="center 38%"') && nailCanvasSource.includes('transformOrigin: "center 38%"') && nailCanvasSource.includes('translateY(-${zoomLift}px) scale(${visualScale})'), 'Hero Canvas transform origin and upward zoom lift prevent bottom clipping at high zoom');

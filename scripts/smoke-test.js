...
function assertNailShopProfilePersistenceSource() {
  ...
  assert(blueprintGalleryRendererSource.includes("export function buildGalleryGrid") && blueprintGalleryRendererSource.includes("availableTrayArea") && blueprintGalleryRendererSource.includes("--gallery-cell-width"), "BlueprintGalleryRenderer includes a Gallery Grid Engine that sizes tray cells to 80-90% artwork fill");
  assert(blueprintGalleryRendererSource.includes("GALLERY_ARTWORK_VIEWBOX") && blueprintGalleryRendererSource.includes("x: 18") && blueprintGalleryRendererSource.includes("y: 18") && blueprintGalleryRendererSource.includes("width: 204") && blueprintGalleryRendererSource.includes("height: 314"), "BlueprintGalleryRenderer tightens the gallery SVG artwork viewBox instead of changing layout scale");
  ...
  assert(nailShopSource.includes('data-testid="blueprint-library-card-collection"') && nailShopSource.includes('data-testid="blueprint-library-card-status"') && nailShopSource.includes('data-testid="blueprint-library-card-readiness"'), "Blueprint Library cards keep collection, status badge, and readiness pill in the main card body");

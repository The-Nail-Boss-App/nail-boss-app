...
function assertNailShopProfilePersistenceSource() {
  ...
  assert(blueprintGalleryRendererSource.includes("getBlueprintGalleryAutoScaleStyle") && blueprintGalleryRendererSource.includes("--gallery-art-fill") && blueprintGalleryRendererSource.includes("--gallery-nail-width"), "BlueprintGalleryRenderer includes composition-aware gallery auto scaling that targets 80-90% artwork fill");

...
function assertNailShopProfilePersistenceSource() {
  ...
  assert(nailShopSource.includes('blueprintCardMetadata') && nailShopSource.includes('blueprintMetadataRow') && nailShopSource.includes('data-testid="blueprint-library-card-metadata"'), "Blueprint card metadata rows are stacked/wrapped");
  assert(nailShopSource.includes("overflowWrap: 'anywhere'") && nailShopSource.includes("wordBreak: 'break-word'"), "long Blueprint titles and metadata wrap safely");

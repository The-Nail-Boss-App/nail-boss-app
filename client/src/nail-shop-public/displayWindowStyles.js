...
export const displayWindowStyles = {
  panel: {
    ...
    boxShadow: '0 18px 46px rgba(0, 0, 0, 0.38), inset 0 1px 0 rgba(217, 221, 231, 0.1)',
  },
  header: { display: 'flex', alignItems: 'end', justifyContent: 'space-between', gap: 12, marginBottom: 10 },
  ...
  grid: { display: 'grid', gridTemplateColumns: 'repeat(5, minmax(0, 1fr))', gap: 8 },
  card: {
    minWidth: 0,
    position: 'relative',
    display: 'grid',
    ...
    boxShadow: '0 12px 24px rgba(0, 0, 0, 0.24), inset 0 1px 0 rgba(255,255,255,.08)',
  },
  imageVisual: { width: '100%', aspectRatio: '5 / 4', display: 'block', objectFit: 'cover', borderRadius: 13, border: '1px solid rgba(255, 47, 146, 0.16)', boxShadow: '0 0 24px rgba(255, 47, 146, 0.14)', background: palette.ink },
  ...
  cardTitle: { margin: 0, color: palette.cream, fontFamily: 'Georgia, "Times New Roman", serif', fontSize: 14, lineHeight: 1.05 },
  category: { margin: 0, color: 'rgba(255, 47, 146, 0.9)', fontSize: 10, fontWeight: 900, letterSpacing: '0.12em', textTransform: 'uppercase' },
  subtitle: { margin: 0, color: palette.mutedCream, fontSize: 11, lineHeight: 1.2 },
  footer: { display: 'none' },

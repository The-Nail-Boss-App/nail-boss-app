...
export const UI = {
  ...
  layout: { flex: 1, minHeight: 0, display: "grid", gridTemplateColumns: "300px minmax(420px, 1fr) 330px", gap: 14, padding: 14, overflow: "hidden" },
  panel: { background: COLORS.surface, border: `1px solid ${COLORS.border}`, borderRadius: 18, boxShadow: "0 10px 30px rgba(60,20,50,.06)", minHeight: 0, overflow: "auto" },
  panelPad: { padding: 16 },

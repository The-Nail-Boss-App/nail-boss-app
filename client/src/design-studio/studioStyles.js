...
export const UI = {
  ...
  commandIdentity: { minWidth: 205, display: "flex", alignItems: "center", gap: 9, flex: "0 1 250px" },
  commandLogo: {
  ...
  commandTitle: { color: "#fffaf7", fontFamily: "Georgia, serif", fontSize: 15, fontWeight: 800, lineHeight: 1.1, whiteSpace: "nowrap" },
  commandCurrentDesign: {
  ...
  commandButton: (active = false, disabled = false) => ({
    ...
    gap: 3,
    whiteSpace: "nowrap",
    border: `1px solid ${active ? "rgba(216,166,66,.72)" : "rgba(255,255,255,.16)"}`,
    background: active ? "rgba(216,166,66,.18)" : "rgba(255,255,255,.08)",
    color: disabled ? "rgba(255,250,247,.42)" : "#fffaf7",
    borderRadius: 8,
    minHeight: 38,
    padding: "6px 7px",
    fontSize: 11,
    ...
    boxShadow: active
      ? "0 0 0 1px rgba(216,166,66,.22), inset 0 1px 0 rgba(255,255,255,.10)"
  ...
  modeToggleGroup: {
    ...
    borderRadius: 999,
    background: "linear-gradient(135deg, rgba(59,31,53,.08), rgba(245,200,232,.38))",
    boxShadow: "0 10px 24px rgba(60,20,50,.10)",
  },
  modeToggleButton: (active = false) => ({
    border: `1px solid ${active ? COLORS.plum : "rgba(123,47,89,.14)"}`,
    background: active ? "linear-gradient(135deg, #3B1F35, #7B2F59)" : "#fff",
    color: active ? "#fffaf7" : COLORS.plum,
    borderRadius: 999,
    minHeight: 34,
    padding: "7px 12px",
    fontSize: 12,
    ...
    textTransform: "uppercase",
    cursor: "pointer",
    boxShadow: active ? "0 12px 28px rgba(123,47,89,.22)" : "0 8px 18px rgba(60,20,50,.06)",
    transition: LUXURY_TRANSITION,
  }),

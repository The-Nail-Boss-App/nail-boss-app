...
const TOOLS = [
  { id: "solid", label: "Solid pen" },
  { id: "glitter", label: "Glitter pen" },
  { id: "soft", label: "Soft brush" },
];
...
export default function DrawingToolbar({ brush, onBrushChange, mode }) {
  ...
  return (
    <section style={{ marginBottom: 18 }}>
      <div style={UI.sectionTitle}>Drawing</div>
      ...
      <p style={{ ...UI.smallText, marginTop: 8 }}>MVP simplification: eraser removes the nearest stroke in the selected drawing layer, while pen strokes remain vector point data clipped to the nail.</p>
    </section>
  );
}

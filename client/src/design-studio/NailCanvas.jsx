...
export function PatternDefs({ layer, id }) {
  ...
  switch (layer.data.pattern) {
    ...
    case "camo": return <pattern id={id} width="86" height="64" patternUnits="userSpaceOnUse" patternTransform={patternTransform(layer)} data-pattern="camo" data-camo-shapes="varied-organic-patches-three-tones"><rect width="86" height="64" fill="transparent"/><path d="M-10 10 C-2 3 7 5 12 10 C18 3 31 5 33 14 C41 14 46 20 43 28 C39 36 27 33 23 29 C17 36 5 36 2 28 C-5 28 -16 20 -10 10Z" fill={c} opacity=".78"/><path d="M44 -5 C52 -1 56 6 53 13 C62 12 72 18 70 27 C68 36 55 38 50 32 C43 39 32 34 34 25 C36 18 45 18 47 13 C39 9 36 0 44 -5Z" fill={s} opacity=".66"/><path d="M15 43 C22 36 32 38 34 45 C42 42 51 47 50 55 C48 64 35 66 30 59 C24 66 12 63 12 55 C6 54 7 47 15 43Z" fill={accent} opacity=".36"/><path d="M58 43 C64 36 76 37 79 45 C88 45 93 52 89 60 C84 68 72 64 68 59 C62 65 52 61 52 53 C47 50 51 45 58 43Z" fill={c} opacity=".62"/><path d="M21 18 C27 13 36 16 37 22 C43 23 45 30 39 34 C33 38 26 34 25 29 C18 31 12 26 15 21 C16 19 18 18 21 18Z" fill={accent} opacity=".42"/><path d="M66 6 C72 3 81 7 82 14 C90 16 91 24 84 28 C78 31 72 28 70 22 C64 23 58 17 61 11 C62 9 64 7 66 6Z" fill={s} opacity=".5"/></pattern>;
    case "houndstooth": return <pattern id={id} width="56" height="56" patternUnits="userSpaceOnUse" patternTransform={patternTransform(layer)} data-pattern="houndstooth" data-houndstooth-shapes="large-interlocking-tooth-check"><rect width="56" height="56" fill={s} opacity=".18"/><path d="M0 0 H28 V10 L38 0 H56 V18 L46 28 H56 V56 H28 V46 L18 56 H0 V38 L10 28 H0 Z" fill={c}/><path d="M28 0 H56 V28 H46 L56 38 V56 H38 L28 46 V56 H0 V28 H10 L0 18 V0 H18 L28 10 Z" fill={s} opacity=".92"/><path d="M28 0 V10 L38 0 Z M46 28 H56 L46 38 Z M18 56 L28 46 V56 Z M0 18 L10 28 H0 Z" fill={c} opacity=".95"/><path d="M0 0 H18 L28 10 V28 H10 L0 18 Z M56 56 H38 L28 46 V28 H46 L56 38 Z" fill={c}/></pattern>;
    case "dots":

...
export default function FullSetPreview({ blueprint, activeNailId, onSelectSlot, onViewChange }) {
  const [view, setView] = useState("full");
  function choose(next) { setView(next); onViewChange?.(); }
  return <section style={{ borderTop: `1px solid ${COLORS.border}`, padding: "10px 14px", background: "#fff" }}>
    <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 8 }}>
      ...
      <span style={{ marginLeft: "auto", color: COLORS.textMuted, fontSize: 12, fontWeight: 700 }}>Click a thumbnail to edit that nail.</span>
    </div>

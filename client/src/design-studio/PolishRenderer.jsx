...
export function PolishSurface({ nail, baseLayer, path, clipId, uid }) {
  ...
  const fillId = data.polishType === "Jelly" ? "jelly" : data.polishType === "Milky" ? "milky" : data.polishType === "Chrome" ? "chrome" : data.polishType === "Cat Eye" ? "cat" : data.polishType === "Gradient" ? "legacy-gradient" : data.polishType === "Marble" ? "cream" : "cream";

...
import { FINISH_DEFAULTS, VISIBLE_POLISH_FINISHES, heroEffectForPolish, normalizePersistedAuraEffect, normalizePolishForFinish, polishSignature } from './polishFinish';
...
function initialNailDeskHeroState() {
  ...
  try {
    ...
    const document = { ...parsed, nail: { ...parsed.nail, effect: normalizePersistedAuraEffect(parsed?.nail?.effect) || heroEffectForPolish(normalized) } };

        ...
        {leftPanelOpen && !focusMode && <aside id="creative-tools-panel" className="nail-design-studio__panel nail-design-studio__creative-tools" role="tabpanel" aria-labelledby={`nail-tool-${activeTool.id}`} tabIndex="0">
          ...
          {['polish', 'effects'].includes(activeTool.id) ? <section className="nail-design-studio__polish-studio" aria-label={activeTool.id === 'polish' ? 'Polish Studio' : 'Effects Studio'} data-hero-material-engine="Hero Material Engine" data-hero-effect-engine="Hero Effect Engine" data-hero-lighting-engine="Hero Lighting Engine" data-hero-document-id={heroDocument.metadata.id}>
            <div className="nail-design-studio__active-polish" data-testid="active-polish-card">
              ...
              <div className="nail-design-studio__active-bottle"><PolishBottle size="medium" selected colorHex={activePolishColor} polishType={activeFinish} name={polishName} opacity={appliedEffect.opacity} viscosity={appliedEffect.viscosity} shine={appliedEffect.shine} glitterDensity={activeFormulation.glitterDensity} shimmerIntensity={activeFormulation.shimmerIntensity} /><MaterialSwatch className="nail-design-studio__active-swatch" finish={activeFinish} color={activePolishColor} fleckColor={activeFormulation.fleckColor} glitterDensity={activeFormulation.glitterDensity}/></div>
              <div className="nail-design-studio__active-details">
                <label className="nail-design-studio__polish-name">Shade<input aria-label="Polish name" value={polishName} maxLength="48" onChange={(event) => setPolishName(event.target.value)} /></label>
